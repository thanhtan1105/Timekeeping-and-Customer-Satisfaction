...
public interface I_URI {
    ...
    String API_ACCOUNT_REMOVE_FACE = "/remove_face";
    String API_ACCOUNT_REMOVE_ALL_FACE = "/remove_all_face";
    ...
    String API_HANDLER_LIST_CONFIGURATION = "/list_config";
    String API_HANDLER_UPDATE_CONFIGURATION = "/update_config";
}
