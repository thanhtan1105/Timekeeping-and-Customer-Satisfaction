...
!function (a) {
    ...
    var b = function (b, c) {
        ...
        } else d.source = d.options.source, d.ajax = null;
        d.shown = !1, d.listen()
    };
    b.prototype = {
        constructor: b, eventSupported: function (a) {
            var b = a in this.$element;
            return b || (this.$element.setAttribute(a, "return;"), b = "function" == typeof this.$element[a]), b
        }, select: function () {
            var a = this.$menu.find(".active");
            if (a.length) {
                var b = a.attr("data-value"), c = this.$menu.find(".active a").text();
            ...
            if (this.$menu.css({top: b.top + b.height, left: b.left}), this.options.alignWidth) {
                var c = a(this.$element[0]).outerWidth();
                this.$menu.css({width: c})
            }
            ...
            var b, c = this;
            if (c.ajax.xhr)return c.ajax.preProcess && (a = c.ajax.preProcess(a)), c.ajax.data = a, b = c.grepper(c.ajax.data) || [], b.length ? (c.ajax.xhr = null, c.render(b.slice(0, c.options.items)).show()) : c.shown ? c.hide() : c
        }, ajaxToggleLoadClass: function (a) {
            this.ajax.loadingClass && this.$element.toggleClass(this.ajax.loadingClass, a)
        }, lookup: function (a) {
            var b, c = this;
            return c.ajax ? void c.ajaxer() : (c.query = c.$element.val(), c.query && (b = c.grepper(c.source)) ? (0 == b.length && (b[0] = {
                id: -21,
                name: "Result not Found"
            }), c.render(b.slice(0, c.options.items)).show()) : c.shown ? c.hide() : c)
        }, matcher: function (a) {
            ...
            }), d.autoSelect && b.first().addClass("active"), this.$menu.html(b), this
        }, grepper: function (b) {
            var c, d, e = this, f = "string" == typeof e.options.displayField;
            if (!(f && b && b.length))return null;
            if (b[0].hasOwnProperty(e.options.displayField))c = a.grep(b, function (a) {
            ...
            if (c.length || (c = this.$menu.find("li").last()), this.options.scrollBar) {
                var d = this.$menu.children("li"), e = d.length - 1, f = d.index(c);
